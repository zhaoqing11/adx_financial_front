                  ...
                  <div class="card card-block card-stretch" id="card_body">
                    <div class="card-body p-0">
                      ...
                      <div class="chart_card">
                        <div class="_left">
                          <h5>部门年度支出统计</h5>
                          <PublicPayCountChart v-if="paymentChartData.length > 0" :chart-data="paymentChartData" :color-data="colorData"/>
                        </div>
                        <div class="_right">
                          <h5>月收入统计</h5>
                          <PublicCollectionChart v-if="collectionChartData.length > 0" :chart-data="collectionChartData" :color-data="colorData"/>
                        </div>
                      </div>
                      <el-table
                        :data="tableData"
...
import PublicPayCountChart from './components/PublicPayCountChart.vue';
import PublicCollectionChart from './components/PublicCollectionChart.vue';

export default {
    components: {
      PublicPayCountChart,
      PublicCollectionChart
    },
    data() {
      return {
        year: '2021',

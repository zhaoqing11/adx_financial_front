            ...
            <div class="col-lg-12">
              <div class="d-flex flex-wrap align-items-center justify-content-between my-schedule mb-4">
                <div class="d-flex align-items-center justify-content-between">
                  <h4 class="font-weight-bold">审批列表</h4>
                </div>  
                  ...
                  <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                      <div class="d-flex justify-content-between align-items-center p-3">
                        <h5 class="font-weight-bold">审批列表</h5>
                            ...
                            <tr class="white-space-no-wrap" v-for="(item,index) in tableData" :key="index">
                              ...
                              <td>
                                <div class="d-flex justify-content-end align-items-center">
                                  <a class="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="javaScript:void(0);" @click="editPaymentForm(item)">
  ...
  methods: {
    ...
    getTableData() {
      const params = {
        ...
        code: this.code,
        idPaymentFormState: this.idPaymentFormState
      } 
      API.getApprovalPaymentForm(params)
      .then(res => {
        if (res.data.status === 200) {
